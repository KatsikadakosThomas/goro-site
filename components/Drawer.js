  ...
  const dropClick=()=>{
    ...
    <div className={`drawer d-flex  flex-column  align-items-md-center ps-4 pt-5 ${props.show?"open":""}`}> 
        <img src={"/x.png"} alt="close" onClick={props.click}/>
         ...
         {show&&<>
            <Link href={`/CaseStudy/airbnb-apartments`}><span className='me-5  mt-3'>case study 1</span></Link>
            <Link href={`/CaseStudy/Marketeers-high-quality-assets`}><span className='me-5  mt-3'>case study 2</span></Link></>}
